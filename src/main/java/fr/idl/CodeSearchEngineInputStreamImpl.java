...
public class CodeSearchEngineInputStreamImpl implements CodeSearchEngineInputStream {
          ...
          while (xmlsr.hasNext()) {
            ...
            try {
              ...
              for (Iterator paramIterator =
                ...
                parameters.add(new TypeImpl(Util.getFullName(typeNameNode), "", null, null));
              }
  ...
  @Override
  public List<Method> findOverridingMethodsOf(CodeSearchEngine.Method method, InputStream data) {
    // TODO Auto-generated method stub
    return null;
  }
